...
local sExclamationBoxContents = {
    ...
    { 0, 0, 0, E_MODEL_TRANSPARENT_STAR,  id_bhvWarp },
    { 1, 0, 0, E_MODEL_TRANSPARENT_STAR,  id_bhvWarp },
    { 2, 0, 0, E_MODEL_TRANSPARENT_STAR,  id_bhvWarp },
    ...
    { 15, 0, 6, E_MODEL_STAR,  id_bhvSpawnedStar },
    { 16, 0, 0, --[[19 -- no existing model]] E_MODEL_NONE,  id_bhvHiddenStarTrigger },
    { 17, 0, 0, E_MODEL_CHUCKYA,  id_bhvChuckya },
    { 18, 0, 0, E_MODEL_BLACK_BOBOMB,  id_bhvBobomb },
    { 19, 0, 0, E_MODEL_BUTTERFLY,  id_bhvButterfly },
    { 20, 0, 0, E_MODEL_CHAIN_CHOMP,  id_bhvChainChomp },
    { 21, 0, 0, E_MODEL_BULLY,  id_bhvBigBullyWithMinions },
    { 22, 0, 0, E_MODEL_BULLY,  id_bhvSmallBully },
    { 23, 0, 0, E_MODEL_MARIOS_WING_CAP,  id_bhvWingCap },
    { 24, 0, 0, E_MODEL_MARIOS_METAL_CAP,  id_bhvMetalCap },
    { 25, 0, 0, E_MODEL_MARIOS_CAP,  id_bhvVanishCap },
    { 26, 0, 0, E_MODEL_RED_FLAME,  id_bhvBouncingFireballFlame }, -- E_MODEL_RED_FLAME_SHADOW?
    { 27, 0, 0, E_MODEL_GOOMBA,  id_bhvGoomba },
    { 28, 0, 1, E_MODEL_GOOMBA,  id_bhvGoomba },
    { 29, 0, 0, E_MODEL_EXPLOSION,  id_bhvExplosion },
    { 30, 0, 0, E_MODEL_BLUE_COIN,  id_bhvMrIBlueCoin },
    { 31, 0, 0, E_MODEL_NONE,  id_bhvBlueFlamesGroup },
    { 99, 0, 0, 0, nil }
}
...
local function exclamation_box_act_broken(obj)
    ...
    if gBehaviorValues.RespawnShellBoxes == 0 then
        table.remove(threshold, 1)
    end

    if threshold[obj.oBehParams2ndByte] then
